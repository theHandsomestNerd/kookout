...
class PostCommentThreadTab extends StatefulWidget {
  const PostCommentThreadTab(
      {super.key,
      required this.id,
  ...
  @override
  State<PostCommentThreadTab> createState() => _PostCommentThreadTabState();
}
            ...
            children: [
              ListTile(
                title: ConstrainedBox(
                  ...
                  child: Row(
                    key: ObjectKey(widget.thisPost?.profileImage),
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      widget.thisPost?.profileImage != null
                          ? Expanded(
                              child: InkWell(
                                onTap: () {
                          ...
                          : SizedBox(
                              ...
                              child: Text(
                                  widget.thisPost?.profileImage.toString() ??
                                      ""),
                            ),
                      // SizedBox(
                      //   width: 150,
